...
class _TransferViewState extends State<TransferView> {
  PaymentMethod paymentMethodfrom = PaymentMethod.cash;
  PaymentMethod paymentMethodTo = PaymentMethod.bank1;
                  ...
                  children: [
                    ...
                    DropdownButtonFormField(
                      ...
                      items: PaymentMethod.values
                          ...
                          .toList(),
                      initialValue: paymentMethodfrom,
                      onChanged: (value) {
                        setState(() {
                          paymentMethodfrom = value!;
                        });
                      },
                    ),
                    DropdownButtonFormField(
                      ...
                      items: PaymentMethod.values
                          ...
                          .toList(),
                      initialValue: paymentMethodTo,
                      onChanged: (value) {
                        setState(() {
                          paymentMethodTo = value!;
                        });
                      },
                    ),
                    TextFormField(
                    ...
                    CustomButton(buttonName: "Transfer", buttonColor: kBlue),
                    SizedBox(height: 10),
                  ],
                ),
              ),
