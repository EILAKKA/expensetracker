...
class _AddIncomeViewState extends State<AddIncomeView> {
  IncomeCategory incomeCategory = IncomeCategory.pasive;
  PaymentMethod paymentMethod = PaymentMethod.cash;
  final TextEditingController _amountControllerIn = TextEditingController();
  final TextEditingController _noteControllerIn = TextEditingController();
  ...
  @override
  void dispose() {
    _amountControllerIn.dispose();

    _noteControllerIn.dispose();
    super.dispose();
  }
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                TextField(
                  controller: _amountControllerIn,
                  style: TextStyle(
                    fontSize: 60,
                    color: kWhite,
